...
class Config(object):
    # Bot Information 
    TECH_VJ_BOT_TOKEN = os.environ.get("TECH_VJ_BOT_TOKEN", "6945924841:AAE8ztQJmu5zn3lMp3TNDnccNdpOfJFPbBI")
    TECH_VJ_BOT_USERNAME = os.environ.get("TECH_VJ_BOT_USERNAME", "Urloadeebot") # Bot username without @.
    
    # The Telegram API things
    TECH_VJ_API_ID = int(os.environ.get("TECH_VJ_API_ID", "20412121"))
    TECH_VJ_API_HASH = os.environ.get("TECH_VJ_API_HASH", "523bf9d5337afc0122be8578f081f5e3")
    ...
    TECH_VJ_OWNER_ID = int(os.environ.get("TECH_VJ_OWNER_ID", "6805059701")) 
    ...
    # channel information
    TECH_VJ_LOG_CHANNEL = int(os.environ.get("TECH_VJ_LOG_CHANNEL", "-1002088211408")) # your log channel id and make bot admin in log channel with full right 
